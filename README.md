# Lamcalcj [![Build Status](https://travis-ci.com/yuxuanchiadm/lamcalcj.svg?branch=1.2.x)](https://travis-ci.com/yuxuanchiadm/lamcalcj)
...
dependencies {
    compile 'org.lamcalcj:lamcalcj-ast:1.2.1'
    compile 'org.lamcalcj:lamcalcj-compiler:1.2.1'
    compile 'org.lamcalcj:lamcalcj-pretty-print:1.2.1'
    compile 'org.lamcalcj:lamcalcj-reducer:1.2.1'
    compile 'org.lamcalcj:lamcalcj-utils:1.2.1'
}
```
